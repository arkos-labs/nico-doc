    ...
    <header className={`fixed top-0 z-50 w-full transition-all duration-300 ${(isScrolled || !isHomePage)
      ...
      <div className="container mx-auto flex items-center justify-between px-6 md:px-12 lg:px-20 h-16">
        ...
        <nav className="hidden lg:flex items-center gap-12 font-display italic text-lg">
          <Link to="/about" className="hover:text-[#ed5518] transition-colors leading-none pt-1">Notre Vision</Link>
          <Link to="/secteurs" className="hover:text-[#ed5518] transition-colors leading-none pt-1">Secteurs</Link>
          <Link to="/logistique" className="hover:text-[#ed5518] transition-colors leading-none pt-1">Logistique</Link>
          <Link to="/faq" className="hover:text-[#ed5518] transition-colors leading-none pt-1">FAQ</Link>
        </nav>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 top-0 z-[60] w-full h-screen bg-noir p-12 lg:hidden flex flex-col justify-center animate-in fade-in zoom-in">
          ...
          <nav className="flex flex-col gap-8 text-4xl font-display italic text-white mb-12">
            <Link to="/about" onClick={() => setIsMenuOpen(false)}>Notre Vision</Link>
            <Link to="/secteurs" onClick={() => setIsMenuOpen(false)}>Secteurs</Link>
            <Link to="/logistique" onClick={() => setIsMenuOpen(false)}>Logistique</Link>
