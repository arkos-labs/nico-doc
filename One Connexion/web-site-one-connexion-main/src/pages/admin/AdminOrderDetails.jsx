      ...
      <AdminPageHeader
        ...
        actions={
          <div className="flex items-center gap-3 flex-wrap">
            <span className={`inline-flex items-center rounded-xl border px-3 py-1.5 text-sm font-black uppercase tracking-widest ${sc.cls}`}>
              {sc.label}
            </span>
            <button
              onClick={async () => {
            ...
            return (
              <div key={step.key} className="flex items-center flex-1 min-w-0">
                <div className="flex flex-col items-center gap-1.5 flex-1">
                  ...
                  <span className={`text-[11px] font-black uppercase tracking-widest text-center ${isCurrent ? 'text-[#ed5518]' : isDone ? 'text-slate-700' : 'text-slate-300'}`}>{step.label}</span>
                </div>
                {i < PIPELINE.length - 1 && (
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl bg-slate-50 border border-slate-100 p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-400">Enlèvement</span>
                </div>
              ...
              <div className="rounded-2xl bg-slate-50 border border-slate-100 p-5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-400">Livraison</span>
                </div>
                <div className="font-black text-slate-900 text-sm">
                  {deliveryName}
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              {[
                ...
                <div key={i} className={`rounded-xl p-3 ${item.hl ? 'bg-orange-50/50 border border-orange-100 ring-1 ring-orange-100' : 'bg-slate-50 border border-transparent'}`}>
                  <div className={`text-[10px] font-black uppercase tracking-widest ${item.hl ? 'text-[#ed5518]' : 'text-slate-400'}`}>{item.label}</div>
