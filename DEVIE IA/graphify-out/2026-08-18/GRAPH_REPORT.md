...
Cohesion: 0.08
Nodes (13): BrandLogo(), BrandLogoProps, Footer(), Route, Route, Route, Route, Route (+5 more)
...
Cohesion: 0.14
Nodes (14): Route, parseCookie(), Route, refreshGoogleToken(), Route, refreshGoogleToken(), Route, Route (+6 more)
...
Cohesion: 0.13
Nodes (15): cmdk, @hookform/resolvers, dependencies, cmdk, @hookform/resolvers, @radix-ui/react-hover-card, @radix-ui/react-menubar, @radix-ui/react-separator (+7 more)
...
Cohesion: 0.18
Nodes (11): eslint-plugin-prettier, globals, devDependencies, eslint-plugin-prettier, globals, @types/node, @types/react, @types/react-dom (+3 more)
...
## Knowledge Gaps
- **397 isolated node(s):** `ServiceTemplate`, `Step`, `GlobalSearchProps`, `QuoteForLines`, `SiretData` (+392 more)
